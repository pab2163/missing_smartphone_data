...
descriptive_timeline_plot_mood = descriptive_timeline_plot_data %>%
  ...
  geom_point(data = dplyr::filter(descriptive_timeline_plot_data, missing_all_passive==TRUE), 
             color = 'black', shape = 4, size = 0.5, aes(color = missing_all_passive, shape ='hi'), alpha = 0.5) + 
...
passive_daily_summary_plot = passive_daily_pattern_data %>%
  ...
  ylim(0, max(passive_daily_pattern_data$n) + 370)

descriptive_fig=cowplot::plot_grid(descriptive_timeline_plot_mood, passive_daily_summary_plot, rel_widths = c(1.8, 1), align = 'h', axis = 'bt')
cowplot::save_plot(descriptive_fig, base_height = 6, base_width = 13, filename = '../../figures/fig1.1_descriptive_missingness.png')
